...
namespace Orc.FilterBuilder
{
    ...
    public static class FilterSchemeExtensions
    {
        ...
        public static Expression<Func<T, bool>> ToLinqExpression<T>(this FilterScheme f)
        {
            ...
            return Expression.Lambda<Func<T, bool>>(f.RootItem.ToLinqExpression(parameterExpr), parameterExpr);
        }
        ...
        public static LambdaExpression ToLinqExpression(this FilterScheme f)
        {
            ...
            return Expression.Lambda(f.RootItem.ToLinqExpression(parameterExpr), parameterExpr);
        }
        ...
        {
            if (f.RootItem.Items.Count != 0)
                return;

            f.RootItem.Items.Add(f.CreatePropertyExpression(targetProperties, f.RootItem));
        }
        ...
        public static void EnsureIntegrity(this ConditionTreeItem conditionTreeItem, IReflectionService reflectionService)
        {
            ...
            if (propertyExpression != null)
                EnsureIntegrity(propertyExpression, reflectionService);
